...
type fundamental struct {
	...
	internal interface{} // internal backup, developer extend
}
...
// OptInternal set error internal
func OptInternal(internal interface{}) Option {
	return func(o *fundamental) {
		o.internal = internal
	}
}

// GetInternal get error option internal
func GetInternal(e error) interface{} {
	if f, ok := e.(*fundamental); ok {
		return f.internal
	}
	return nil
